...
public record Switch(BooleanSetting setting, int x, int y, int height) implements ViewmodelGuiObj {
    ...
    @Override
    public void render(@NotNull GuiGraphics context, int mouseX, int mouseY) {
        ...
        context.drawString(ViewmodelScreen.mc.font, Boolean.toString(settingValue), this.x + (this.height << 1) + 1, (int) (this.y + this.height / 2.0f - ViewmodelScreen.mc.font.lineHeight / 2.0f), -1);
    }
